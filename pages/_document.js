  ...
  return (
    ...
    >
      <Head>
        ...
        {/* example as CancelMySubs without .com */}
        <meta
        ...
        <meta
          property="og:title"
          // example as CancelMySubs - Monitor your website, and server
        ...
        <meta
          property="og:image"
          // add to public og image and it will be as https://cancelmysubs.com/og-image.png
        ...
        <meta
          name="twitter:title"
          // CancelMySubs - Monitor your website, and server
          content={customConfig.seo.og.title}
        />
        <meta
          ...
          content={customConfig.seo.description}
        />
        {/* example as https://cancelmysubs.com/twitter.png */}
