...
function Sabyr({ posts }) {
  ...
  return (
    <div className="mx-auto">
      <Head>
        <title>{customConfig.blog.author.name}, author at CancelMySubs Blog</title>
        <meta
          name="description"
          content={`${customConfig.blog.author.name}, Author at CancelMySubs's Blog`}
        />
        <meta name="keywords" content={"cancelmysubs.com"} />
        <link
          rel="canonical"
          href={`https://cancelmysubs.com/blog/author/sabyr`}
        />
        <meta
          property="og:title"
          content={`Sabyr Nurgaliyev, Author at CancelMySubs's Blog`}
        />
        <meta
        ...
        <meta
          property="og:url"
          content={`https://cancelmysubs.com/blog/author/sabyr`}
        />
        ...
        <section className="max-w-3xl mx-auto flex flex-col md:flex-row gap-8 mt-12 mb-24 md:mb-32">
          ...
          <div className="max-md:order-first flex md:flex-col gap-4 shrink-0">
            <Image
              ...
              alt={`Sabyr Nurgaliyev - CancelMySubs Founder`}
              width={256}
              height={256}
